...
- Descontos agressivos no pré-lançamento
...
A janela de oportunidade é o **pré-lançamento**. É nesse momento que você define como o mercado vai perceber seu empreendimento.
...
A velocidade de venda é definida no pré-lançamento, não no stand.
